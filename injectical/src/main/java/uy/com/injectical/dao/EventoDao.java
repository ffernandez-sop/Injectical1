...
public class EventoDao {
	...
	public EventoDao (DbConnection conn) { this.conn = conn;}
	
	public Collection<Evento> getEvento() throws SQLException, IOException {
		...
		while(rs.next()) {
			result.add(new Evento(Integer.valueOf(rs.getInt("id_evento")), 
									rs.getNString("pais"), 
